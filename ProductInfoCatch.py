...
excel_file_name = 'Daten_Html(second-LastPage)/(2.-last)Handys&Smartphones.xlsx'
...
for current_html in dataframe_html['ProductCategory']:
    try:
        current_result_info = productInfoCatch(current_html)
        current_result.append(current_result_info)
    except Exception as e:
        pass
print('current_result:',current_result)

#================ save data to json==========================================================
json_file_name = 'Daten_Json(06.Feb)/(2.-last)Handys&SmartphonesToProductsInfo.json'
a = []
